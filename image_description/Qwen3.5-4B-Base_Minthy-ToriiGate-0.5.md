...
| 序号 | 格式名称 | 中文用途 | 需角色名 | 输出形式 | 推荐用途 | 📋 提示词模板 (点击展开复制) |
|:---:|:---|:---|:---:|:---|:---|:---|
| 1 | Long Thoughts v2 | 最详细的结构化描述 | ✅ | 分章节长文本 | 制作高质量数据集 | <details><summary>📎 复制模板</summary><pre># Captioning format:<br>Your answer must contain 6 parts:<br>&lt;format&gt;<br># 1. Thoughts about characters<br>...<br># 2. Key details<br>...<br># 3. Long description<br>...<br># 4. Detailed description for each character<br>...<br>&lt;/format&gt;<br><br># Characters on picture:<br>Try to recognize...</pre></details> |
| 2 | Long Thoughts | 详细描述+个体部件列表 | ✅ | 分章节长文本 | 元素精细拆解 | <details><summary>📎 复制模板</summary><pre># Captioning format:<br>Your answer must contain 6 parts:<br>&lt;format&gt;<br># 1. Thoughts about characters<br>...<br># 2. General description<br>...<br># 3. Detailed description for each character<br>...<br># 4. Individual Parts<br>...<br># 5. Texts on image<br>...<br># 6. Background and effects<br>&lt;/format&gt;<br><br># Characters on picture:<br>Try to recognize...</pre></details> |
| 3 | Chroma-style | 模仿 Midjourney 风格 | ❌ | 四段式文本 | 直接作为 AI 绘图 Prompt | <details><summary>📎 复制模板</summary><pre># Captioning format:<br>Your task is to describe...<br>### 1. Regular Summary:<br>...<br>### 2. Individual Parts:<br>...<br>### 3. Midjourney-Style Summary:<br>...<br>### 4. DeviantArt Commission Request<br>...<br><br># Characters on picture:<br>Avoid to guess names.</pre></details> |
| 4 | Minimalistic Structured Markdown | 简洁的 Markdown 结构 | ✅ | 带标题短文本 | 下游 Prompt 或展示 | <details><summary>📎 复制模板</summary><pre># Captioning format:<br>Your answer must contain 3 parts:<br>&lt;format&gt;<br># 1. Thoughts about characters<br>...<br># 2. Key details<br>...<br># 3. Structured description<br>...<br>&lt;/format&gt;<br>In general stick to shorter descriptions.<br><br># Characters on picture:<br>Try to recognize...</pre></details> |
| 5 | Minimalistic Structured Json | 机器最易读的 JSON | ❌ | JSON 字符串 | 批量数据处理 | <details><summary>📎 复制模板</summary><pre># Captioning format:<br>Use json-style caption...<br>{"General" : "...",<br>"character_1" : "...",<br>"image_effects" : "...",<br>"texts" : "...",<br>"watermarks" : "..."}<br><br># Characters on picture:<br>Avoid to guess names.</pre></details> |
| 6 | Json | 功能更全的 JSON | ❌ | JSON 字符串 | 完整数据采集 | <details><summary>📎 复制模板</summary><pre># Captioning format:<br>Use json-style caption...<br>{"character" : "...",<br>"background" : "...",<br>"image_effects" : "...",<br>"texts" : "...",<br>"atmosphere" : "..."}<br><br># Characters on picture:<br>Avoid to guess names.</pre></details> |
| 7 | Markdown Comic | 专门描述漫画分镜 | ✅ | 分章节 Markdown | 漫画分镜描述 | <details><summary>📎 复制模板</summary><pre># Captioning format:<br>Use markdown format...<br>&lt;format&gt;<br># 1. Thoughts about characters<br>...<br># 2. Key details<br>...<br># 3. Comic format<br>...<br># 4. Details for each frame<br>...<br># 5. Extra comment<br>&lt;/format&gt;<br><br># Characters on picture:<br>Try to recognize...</pre></details> |
| 8 | Json Comic | 机器可读的漫画描述 | ❌ | JSON 字符串 | 批量处理漫画数据集 | <details><summary>📎 复制模板</summary><pre># Captioning format:<br>Use json-style caption...<br>{<br>"comic_format": "...",<br>"1st_frame": "...",<br>"character_1": "...",<br>"meaning": "..."<br>}<br><br># Characters on picture:<br>Avoid to guess names.</pre></details> |
| 9 | Long / Short | 普通纯文本描述 | ❌ | 纯文本段落 | 快速获取纯文本描述 | <details><summary>📎 复制 Long</summary><pre># Captioning format:<br>Make a caption...<br>Use 2 to 5 paragraphs.<br><br># Characters on picture:<br>Avoid to guess names.</pre></details><details><summary>📎 复制 Short</summary><pre># Captioning format:<br>The caption should be quite short...<br><br># Characters on picture:<br>Avoid to guess names.</pre></details> |
